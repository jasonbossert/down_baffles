...
class Baffle:
    ...
    def __init__(self, width, height, 
        ...
        self._down_conductivity = down_conductivity
        self.len_unit = self.fabric_width.units
    ...
    def _opt_radius(self):
        return minimize(lambda radius: -1*self._baffle_area(radius).magnitude, 2).x * self.len_unit
